!function(t, n) {
    ...
    , function(t, n, e) {
        var r = e(1)
          ...
          , u = e(66);
        t.exports = function(t, n) {
            var e, f, l, d, p, v = t.target, h = t.global, g = t.stat;
    ...
    , function(t, n, e) {
        ...
        (t.exports = function(t, n, e, o) {
            var s = !!o && !!o.unsafe
              , u = !!o && !!o.enumerable
              , f = !!o && !!o.noTargetGet;
            "function" == typeof e && ("string" != typeof n || c(e, "name") || i(e, "name", n),
            l(e).source = d.join("string" == typeof n ? n : "")),
            t !== r ? (s ? !f && t[n] && (u = !0) : delete t[n],
            u ? t[n] = e : i(t, n, e)) : u ? t[n] = e : a(n, e)
        }
    ...
    , function(t, n, e) {
        var r, o, i, c = e(63), a = e(1), s = e(6), u = e(4), f = e(3), l = e(19), d = e(20), p = a.WeakMap;
        if (c) {
            var v = new p
              , h = v.get
              , g = v.has
        ...
        var r = e(10)
          ...
          , c = function(t) {
            return function(n, e, c) {
                var a, s = r(n), u = o(s.length), f = i(c, u);
                if (t && e != e) {
                    for (; u > f; )
                        if ((a = s[f++]) != a)
                            return !0
    ...
    , function(t, n, e) {
        ...
        t.exports = function(t, n, e, f, p, m, b) {
            ...
            }, _ = n + " Iterator", E = !1, L = t.prototype, j = L[g] || L["@@iterator"] || p && L[p], A = !h && j || O(p), C = "Array" == n && L.entries || j;
            if (C && (x = i(C.call(new t)),
            v !== Object.prototype && x.next && (l || i(x) === v || (c ? c(x, v) : "function" != typeof x[g] && s(x, g, y)),
            a(x, _, !0, !0),
            l && (d[_] = y))),
            "values" == p && j && "values" !== j.name && (E = !0,
            A = function() {
                return j.call(this)
            }
            ),
    ...
    , function(t, n, e) {
        "use strict";
        var r, o, i, c = e(58), a = e(4), s = e(3), u = e(0), f = e(17), l = u("iterator"), d = !1;
        [].keys && ("next"in (i = [].keys()) ? (o = c(c(i))) !== Object.prototype && (r = o) : d = !0),
        null == r && (r = {}),
        f || s(r, l) || a(r, l, (function() {
            return this
        }
        )),
        t.exports = {
    ...
    , function(t, n, e) {
        ...
        : function(t) {
          ...
          , it = function(t, n, e) {
            ...
            var r = h(n, !0);
            return d(e),
            u(J, r) ? (e.enumerable ? (u(t, B) && t[B][r] && (t[B][r] = !1),
            e = y(e, {
                enumerable: g(0, !1)
            })) : (u(t, B) || q(t, B, g(1, {})),
            t[B][r] = !0),
          ...
          , st = function(t, n) {
            ...
            if (e !== D || !u(J, r) || u($, r)) {
                var o = z(e, r);
                return !o || !u(J, r) || u(e, B) && e[B][r] || (o.enumerable = !0),
                o
            }
        }
          , ut = function(t) {
    ...
    , function(t, n, e) {
        ...
        r({
            ...
            concat: function(t) {
                var n, e, r, o, i, c = a(this), l = f(c, 0), d = 0;
                for (n = -1,
                r = arguments.length; n < r; n++)
                    if (i = -1 === n ? c : arguments[n],
                    h(i)) {
    ...
    , function(t, n, e) {
        ...
        var r = e(49)
          ...
          , u = e(79);
        t.exports = function(t) {
            var n, e, f, l, d, p = o(t), v = "function" == typeof this ? this : Array, h = arguments.length, g = h > 1 ? arguments[1] : void 0, y = void 0 !== g, m = 0, b = u(p);
            if (y && (g = r(g, h > 2 ? arguments[2] : void 0, 2)),
            null == b || v == Array && c(b))
                for (e = new v(n = a(p.length)); n > m; m++)
                    s(e, m, y ? g(p[m], m) : p[m]);
            else
                for (d = (l = b.call(p)).next,
                e = new v; !(f = d.call(l)).done; m++)
    ...
    , function(t, n, e) {
        ...
        var c = "undefined" != typeof window && window.navigator && window.navigator.platform && (/iP(ad|hone|od)/.test(window.navigator.platform) || "MacIntel" === window.navigator.platform && window.navigator.maxTouchPoints > 1)
          ...
          , p = function(t) {
            ...
            return !!d(n.target) || (n.touches.length > 1 || (n.preventDefault && n.preventDefault(),
            !1))
        }
          , v = function() {
            setTimeout((function() {
                ...
                !function(t) {
                    setTimeout((function() {
                        if (void 0 === l) {
                            ...
                            n && e > 0 && (l = document.body.style.paddingRight,
        ...
        var b = function() {
            ...
            (e = [{
                ...
                value: function(t) {
                    ...
                    o >= 0 && o <= 100 && (this.settings.verticalMode ? this.control.style.top = "calc(".concat(o, "% - ").concat(this.slideWidth / 2, "px)") : this.control.style.left = "calc(".concat(o, "% - ").concat(this.slideWidth / 2, "px)"),
                    this.settings.fluidMode ? this.settings.verticalMode ? this.wrapper.style.clipPath = "inset(0 0 ".concat(100 - o, "% 0)") : this.wrapper.style.clipPath = "inset(0 0 0 ".concat(o, "%)") : this.settings.verticalMode ? this.wrapper.style.height = "calc(".concat(o, "%)") : this.wrapper.style.width = "calc(".concat(100 - o, "%)"))
                }
            }, {
                key: "_activate",
                value: function(t) {
                ...
                value: function() {
                    ...
                    this.settings.labelOptions.onHover && (n.classList.add("on-hover"),
                    e.classList.add("on-hover")),
                    this.settings.verticalMode && (n.classList.add("vertical"),
                    ...
                    this.settings.showLabels && (this.el.appendChild(n),
